...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        #calculate Q values and return the maximum
    ...
    def computeActionFromQValues(self, state):
        ...
        actions = []
        #default for terminal states
        result = None
        
        for action in self.getLegalActions(state):
            #check if Q value of this state is the maximum possible, if so, add it to actions set
    ...
    def getAction(self, state):
        ...
        #epsilon-greedy iplementation
        #choose the best action possible or choose a random legal action, each with a specific probibility.
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        #sample = R(s,a,,s') + gamma (max on a' Q(s',a')
        sample = reward + self.discount * self.computeValueFromQValues(nextState)
        
        #Q(s,a) <- (1 - alpha) Q(s,a) + (a) [sample]
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        #𝑑𝑖𝑓𝑓𝑒𝑟𝑒𝑛𝑐𝑒 = (𝑟 + γ 𝑚𝑎𝑥 𝑎′𝑄(𝑠′, 𝑎′)) − 𝑄(𝑠, 𝑎)
        g = self.discount
        difference = (reward + g * self.computeValueFromQValues(nextState)) - self.getQValue(state, action)
